            ...
            <div className={style.container_log}>
                ...
                <div className={style.blockAvatar}>
                    <div className={style.imgAvatar} >
                        <img style={{borderRadius:'50%'}} alt={'img'} src={userAvatar}/>
                    </div>
                    ...
                    <div>
                        <NavLink to={PATH.PROFILE}><SuperButton style={{background:'rgba(232, 226, 226, 0.57)', width:'100px', fontSize:'14px', color:"#8F2131FF"}}>Cancel</SuperButton></NavLink>
